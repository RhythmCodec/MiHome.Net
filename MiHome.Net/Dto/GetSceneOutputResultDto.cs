...
public class Result
{
    ...
    /// 额外json
    /// </summary>
    public List<SceneDto> SceneInfoList { get; set; } = [];

    public int DistanceCeiling { get; set; }
}
...
public class SceneDto
{
    ...
    /// 场景绑定的所有触发器
    /// </summary>
    public required SceneTriggerBinding SceneTrigger { get; set; }

    /// <summary>
    ///  场景绑定的所有条件
    /// </summary>
    public required SceneConditionBinding SceneCondition { get; set; }

    /// <summary>
    ///  场景绑定的所有动作
    /// </summary>
    public required SceneActionBinding SceneAction { get; set; }
    ...
    /// 通用使用过的房间id列表
    /// </summary>
    [JsonPropertyName("common_used_roomIds")]
